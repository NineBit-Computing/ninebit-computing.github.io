describe("External Website Availability Checks", () => {
  ...
  it("should load https://docs.ninebitciq.com/ and contain 'Welcome to CIQ by NineBit'", () => {
    ...
    cy.title().should('eq', 'CIQ by NineBit — Your AI Platform for Unstructured Documents | NineBit CIQ Docs');
  ...
  xit("should load https://ninebitciq.com and contain 'NineBit CIQ: Rapid Prototyping Platform for AI/ML'", () => {
    ...
    cy.title().should('eq', 'Private LLM Development Platform for AI & ML | NineBit CIQ');
